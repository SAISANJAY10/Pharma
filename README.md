...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-5">
        <img src="Screenshot 2024-05-12 192629.png" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
      <div class="col-md-4">
        <img src="Screenshot 2024-05-12 192642.png" class="img-fluid" alt="Pharmacy Image" width="2000" height="2000">
      </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany - SAI SANJAY R(212223040178). All rights reserved.</p>
  </footer>
  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="Screenshot 2024-05-12 192658.png" class="card-img-top" alt="Product 1">
            <div class="card-body">
          ...
          <div class="card">
            <img src="Screenshot 2024-05-12 192710.png" class="card-img-top" alt="Product 2">
            <div class="card-body">
          ...
          <div class="card">
            <img src="Screenshot 2024-05-12 192723.png" class="card-img-top" alt="Product 3">
            <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          LIC building,chennai<br>
          <br>
          <strong>Email:</strong><br>
          batman10@gmail.com<br><br>
...
## OUTPUT:
![alt text](<Screenshot 2024-05-12 195855-1.png>)

![alt text](<Screenshot 2024-05-12 195908-1.png>)
![alt text](<Screenshot 2024-05-12 195921-1.png>)
![alt text](<Screenshot 2024-05-12 195932-1.png>)
## RESULT:
